import { Controller, Get, Put, Req, Body, UseGuards, UploadedFile, UseInterceptors } from '@nestjs/common';
...
export class UsersController {
  ...
  async updateMe(
    ...
    const updatedUser = await this.usersService.updateMe(req.user.userId, updateUserDto, file);
